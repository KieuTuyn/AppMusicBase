...
const ChillHits = () => {
    ...
    const WillowImage = () => {
        return renderBackgroundImage(require("../../images/Willow.png"), 96, 96, 0, 0);
    };
    const IDonCareImage = () => {
        return renderBackgroundImage(require("../../images/IDonCare.png"), 96, 96, 0, 0);
    };
    const PutYouRecordsOnImage = () => {
        return renderBackgroundImage(require("../../images/PutYouRecordsOn.png"), 96, 96, 0, 0);
    };
    const GLoveLikeThatImage = () => {
        return renderBackgroundImage(require("../../images/LoveLikeThat.png"), 96, 96, 0, 0);
    };
