...
const PartySong = () => {
    ...
    const BackgroundHeadingImage = () => {
      return renderBackgroundImage(require("../../../assets/images/ImageParty.png"), 261, 375, 0 ,0);
    };
    const ElectricFeelImage = () => {
        return renderBackgroundImage(require("../../../assets/images/ElectricFeel.png"), 96, 96, 0, 0);
    };
    const PumPedUpKicksImage = () => {
        return renderBackgroundImage(require("../../../assets/images/PumPedUpKicks.png"), 96, 96, 0, 0);
    };
    const SeptemberImage = () => {
        return renderBackgroundImage(require("../../../assets/images/September.png"), 96, 96, 0, 0);
    };
    const GetLuckyImage = () => {
        return renderBackgroundImage(require("../../../assets/images/GetLucky.png"), 96, 96, 0, 0);
    };
